document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderCalendar() {
        ...
        for (let day = 1; day <= lastDate; day++) {
            ...
            if (day === 27 && month == 6 && year == 2024 || day == 28 && month == 6 && year == 2024) {
                ...
                userSchedule.style.marginTop = "5px";
                userSchedule.style.padding = "5px";
                userSchedule.style.position = 'absolute';
    ...
    const iconMap = {
        '01d': 'weather_icons/clear-day.svg',
        '01n': 'weather_icons/clear-night.svg',
        '02d': 'weather_icons/partly-cloudy-day.svg',
        '02n': 'weather_icons/partly-cloudy-night.svg',
        '03d': 'weather_icons/cloudy.svg',
        '03n': 'weather_icons/cloudy.svg',
        '04d': 'weather_icons/cloudy.svg',
        '04n': 'weather_icons/cloudy.svg',
        '09d': 'weather_icons/rain.svg',
        '09n': 'weather_icons/rain.svg',
        '10d': 'weather_icons/rain.svg',
        '10n': 'weather_icons/rain.svg',
        '11d': 'weather_icons/thunderstorm.svg',
        '11n': 'weather_icons/thunderstorm.svg',
        '13d': 'weather_icons/snow.svg',
        '13n': 'weather_icons/snow.svg',
        '50d': 'weather_icons/fog.svg',
        '50n': 'weather_icons/fog.svg'
    };
